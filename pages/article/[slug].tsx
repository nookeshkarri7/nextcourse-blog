    ...
    return (
        <>
            <Head>
                ...
                />
                <link rel="icon" href="https://nextcourse.in/NextCourse-fav.png" />
            </Head>
            <div className="my-12 grid lg:grid-cols-3 gap-12 single-article">
                ...
                {/* <div className="sticky top-0">
                    ...
                    <input
                        className="border w-full p-2 pl-3 my-6 outline-blue-500"
                        type="email"
                        placeholder="Your work email"
                    />
                    <button className="border-2 border-blue-500 rounded py-1 px-6 text-blue-500 font-bold">
                        Subscribe
                    </button>
